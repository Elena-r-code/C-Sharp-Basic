    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                {
                    Console.WriteLine("Choose genre with number!");
                    ...
                    {
                        List<Movie> moviesList = currentCinema.ListOfMovies.Where(x => x.Genre.ToString() == genres.ToString()).ToList();
                        Console.WriteLine($"You chose {genres.ToString()} movies");
                        foreach(Movie movie in moviesList)
                        {
                            Console.WriteLine(movie.Title);
                        }
                        Console.WriteLine("Now choose a movie");
                        string chosenMovie = Console.ReadLine();
                        currentCinema.WatchMovie(moviesList.FirstOrDefault(x => x.Title.ToLower() == chosenMovie.ToLower()));
                    }
                   else
                   {

                        Console.WriteLine("Please choose genre from the list!!!!!");
                    }
